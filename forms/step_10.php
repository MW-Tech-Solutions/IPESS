...
// Final Decisions
if (in_array($app_current_status, ['APPROVED_BY_POSTGRADUATE_SCHOOL', 'REJECTED_BY_POSTGRADUATE_SCHOOL', 'ADMISSION_APPROVED', 'ADMISSION_REJECTED'], true) || in_array(strtolower($public_status), ['admitted', 'rejected'], true)) {
