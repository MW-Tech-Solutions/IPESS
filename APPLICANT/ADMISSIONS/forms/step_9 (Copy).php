...
<div class="accordion" id="reviewAccordion">
        ...
        <div id="collapse1" class="accordion-collapse collapse show" data-bs-parent="#reviewAccordion">
            <div class="accordion-body">
                <table class="table table-sm table-borderless">
                    ...
                    <tr><td class="text-muted">Origin:</td><td class="fw-bold"><?php echo ($all_data['step_1']['state'] ?? '') . ' / ' . ($all_data['step_1']['lga'] ?? ''); ?></td></tr>
                </table>
    ...
    <div class="accordion-item">
        ...
        <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#reviewAccordion">
            <div class="accordion-body">
                <table class="table table-sm table-borderless">
                    <tr><td class="text-muted w-25">Status:</td><td class="fw-bold"><?php echo $all_data['step_4']['nysc_status'] ?? ''; ?></td></tr>
                    <tr><td class="text-muted">Cert No:</td><td class="fw-bold"><?php echo $all_data['step_4']['nysc_number'] ?? 'N/A'; ?></td></tr>
                    <tr><td class="text-muted">Year:</td><td class="fw-bold"><?php echo $all_data['step_4']['nysc_year'] ?? 'N/A'; ?></td></tr>
                </table>
                <a href="?step=4" class="btn btn-sm btn-outline-primary">Edit Step 4</a>
            </div>
        </div>
    </div>
    ...
    <div class="accordion-item">
        ...
        <div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#reviewAccordion">
            <div class="accordion-body">
                <table class="table table-sm table-borderless">
                    <tr><td class="text-muted w-25">Status:</td><td class="fw-bold"><?php echo $all_data['step_5']['emp_status'] ?? ''; ?></td></tr>
                    <?php if(($all_data['step_5']['emp_status'] ?? '') == 'Employed'): ?>
                    <tr><td class="text-muted">Employer:</td><td class="fw-bold"><?php echo $all_data['step_5']['employer'] ?? ''; ?></td></tr>
                    <tr><td class="text-muted">Role:</td><td class="fw-bold"><?php echo $all_data['step_5']['job_title'] ?? ''; ?></td></tr>
                    <tr><td class="text-muted">Years:</td><td class="fw-bold"><?php echo $all_data['step_5']['years_experience'] ?? ''; ?></td></tr>
                    <?php endif; ?>
                </table>
                <a href="?step=5" class="btn btn-sm btn-outline-primary">Edit Step 5</a>
            </div>
        </div>
    </div>
    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6">
                Step 6: Research Details
            </button>
        </h2>
        <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#reviewAccordion">
            <div class="accordion-body">
                <p class="mb-1 text-muted small">Proposed Research Area:</p>
                <p class="fw-bold"><?php echo $all_data['step_6']['proposed_research_area'] ?? ''; ?></p>
                <p class="mb-1 text-muted small">Statement of Purpose:</p>
                <p class="small"><?php echo nl2br(htmlspecialchars($all_data['step_6']['statement_of_purpose'] ?? '')); ?></p>
                <a href="?step=6" class="btn btn-sm btn-outline-primary">Edit Step 6</a>
            </div>
        </div>
    </div>
                    ...
                    <?php if(isset($all_data['step_7']['ref_name'])): ?>
                        <?php foreach($all_data['step_7']['ref_name'] as $i => $name): ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="small mb-2"><?php echo $all_data['step_7']['ref_email'][$i]; ?></p>
                            </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
            ...
            <div class="accordion-body">
                <ul class="list-group list-group-flush small">
                    ...
                    $labels = [
                        ...
                        'olevel_file_2' => 'O-Level Result (Sitting 2)',
                    ...
                    foreach($labels as $key => $label){
                        $status = isset($docs[$key]) ? '<span class="text-success"><i class="bi bi-check-circle"></i> Uploaded</span>' : '<span class="text-danger">Missing</span>';
...
document.addEventListener("DOMContentLoaded", () => {
    drawCaptcha(); // Initialize on load
    
    const verifyBtn = document.getElementById("verifyCaptchaBtn");
    const mainForm = document.querySelector('form'); // Adjust selector to your actual form tag
    ...
    // Prevent form submission if captcha not verified
    if(mainForm) {
        ...
        //     }
        // });
        // Function to focus the user on the captcha input
...
document.addEventListener("DOMContentLoaded", () => {
    // ... your existing drawCaptcha and verifyBtn logic ...
