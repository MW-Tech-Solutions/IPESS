...
<div class="accordion" id="reviewAccordion">
    ...
    <div class="accordion-item">
        ...
        <div id="collapse7" class="accordion-collapse collapse" data-bs-parent="#reviewAccordion"><div class="accordion-body"><div class="row"><?php if(isset($all_data['step_7']['ref_name'])): ?><?php foreach($all_data['step_7']['ref_name'] as $i => $name): ?><?php if(!empty($name)): ?><div class="col-md-4"><p class="mb-0 fw-bold"><?php echo $name; ?></p><p class="small text-muted mb-0"><?php echo $all_data['step_7']['ref_org'][$i]; ?></p><p class="small mb-2"><?php echo $all_data['step_7']['ref_email'][$i]; ?></p></div><?php endif; ?><?php endforeach; ?><?php endif; ?></div><a href="?step=7" class="btn btn-sm btn-outline-primary">Edit Step 7</a></div></div>
    </div>
