...
<head>
    ...
    <title>Forgot Password - IPESS JOSTUM</title>
    ...
    <style>
        ...
        .recovery-card {
            width: 100%;
            max-width: 450px;
            background: url('https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80');
...
<div class="recovery-card">
    <div class="form-overlay">
        ...
        <div class="footer-copy">
            &copy; <?php echo date('Y'); ?> IPESS JOSTUM Portal
        </div>
    </div>
</div>
...
<!-- <script>
    ...
    recoveryForm.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            ...
            // Visual feedback: Change icon color to green temporarily
            formIcon.style.color = '#2ecc71';
    ...
    function closeAlert() {
        ...
        formIcon.style.color = 'var(--accent-yellow)';
    }
</script> -->
<script>
    const recoveryForm = document.getElementById('recoveryForm');
    ...
    recoveryForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                ...
                statusAlert.innerText = data.message;
                statusAlert.className = "alert alert-danger fade show mt-3";
                statusAlert.style.display = 'block';
                formIcon.style.color = '#e74c3c';
            }
        })
        .catch(error => {
