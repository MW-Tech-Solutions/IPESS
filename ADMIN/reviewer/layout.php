...
<head>
    ...
    <title>JOSTUM PG SCHOOL - Reviewer Dashboard</title>
            ...
            <div class="sidebar-nav">
                <ul class="nav flex-column">
                    <li class="nav-item dropdown">
                        <a class="nav-link active" href="#review" data-bs-toggle="tab" data-bs-target="#review">
                            <i class="fas fa-clipboard-check"></i>
                            <span>Applications for Review</span>
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#evaluation" data-bs-toggle="tab" data-bs-target="#evaluation">
                            <i class="fas fa-star-half-alt"></i>
                            <span>Academic Evaluation</span>
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="#history" data-bs-toggle="tab" data-bs-target="#history">
