        ...
        <div class="content-area">
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <div>
                        <div class="topbar-title"><?php echo htmlspecialchars($pageTitle ?? 'Reviewer'); ?></div>
                ...
                <div class="topbar-actions">
                    <div class="topbar-search">
                        ...
                        <input type="text" id="admin-global-search-input" placeholder="Search applications, reviews..." autocomplete="off">
