                        ...
                        <div class="d-flex gap-2 mt-3 mt-md-0">
                            <?php if (has_permission('department_review')): ?>
                                <form method="POST" action="../includes/process_decision.php" class="decision-form">
                                    ...
                                    <input type="hidden" name="redirect" value="../general/view.php?app_no=<?php echo urlencode($appNumber); ?>">
                            ...
                            <?php else: ?>
                                <span class="text-muted small italic">Decisions are locked based on your assigned duties.</span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="d-flex flex-column gap-2">
        ...
        <?php foreach ($uploaded_documents as $doc): ?>
            <?php
                ...
                $filePath = htmlspecialchars($filePath = getPublicFilePath($doc['file_path']));
