        ...
        $notificationCount = $unreadCount + $newUserCount;
...
<div class="topbar-left">
                    ...
                    <div>
                        <div class="topbar-title"><?php echo htmlspecialchars($pageTitle ?? 'Super Admin'); ?></div>
                ...
                <div class="topbar-actions">
                    <div class="topbar-search">
                        ...
                        <input type="text" id="admin-global-search-input" placeholder="Search records, users, audits..." autocomplete="off">
                    ...
                    <div class="dropdown">
                        <button class="icon-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <?php if ($notificationCount > 0): ?>
                                <span class="icon-badge"><?php echo (int) $notificationCount; ?></span>
                            <?php endif; ?>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <?php if (!empty($notifications)): ?>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <li><span class="dropdown-item text-muted">No admin notifications yet.</span></li>
                            <?php endif; ?>
                            <li><hr class="dropdown-divider"></li>
                            <li><h6 class="dropdown-header">New Registrations</h6></li>
                                ...
                                <?php foreach ($newUsers as $user): ?>
                                    <li>
                                        <a class="dropdown-item" href="#">
                                            ...
                                            <div class="text-muted small"><?php echo date('M d, H:i', strtotime($user['created_at'])); ?></div>
                                        </a>
                                    </li>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <li><span class="dropdown-item text-muted">No new registrations.</span></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <div class="dropdown">
