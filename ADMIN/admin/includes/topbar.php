...
if ($pdo) {
    try {
        ...
        if (!empty($userRow)) {
            ...
            $currentUser['role'] = $userRow['role_name'] ?: $currentUser['role'];
            ...
            <header class="topbar">
                ...
                <div class="topbar-actions">
                    <div class="topbar-search">
                        ...
                        <input type="text" id="admin-global-search-input" placeholder="Search students, supervisors, applications..." autocomplete="off">
...
(() => {
    ...
    async function runSearch() {
        ...
        try {
            const res = await fetch(`api/global-search.php?q=${encodeURIComponent(q)}`);
