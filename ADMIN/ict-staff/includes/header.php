...
require_role_or_permission(['ICT_STAFF', 'SUPER_ADMIN', 'ICT_ADMIN'], 'ict_processing', 'ADMIN/login.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo htmlspecialchars($pageTitle ?? 'ICT Desk'); ?> | JOSTUM PG School</title>
