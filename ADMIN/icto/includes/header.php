...
require_role_or_permission(['ICTO', 'SUPER_ADMIN', 'ICT_ADMIN'], 'verify_applicants', 'ADMIN/login.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo htmlspecialchars($pageTitle ?? 'ICTO Desk'); ?> | JOSTUM PG School</title>
