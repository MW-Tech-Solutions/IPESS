...
require_role_or_permission(['FACULTY_OFFICER', 'SUPER_ADMIN', 'ICT_ADMIN'], 'faculty_review', 'ADMIN/login.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title><?php echo htmlspecialchars($pageTitle ?? 'Faculty Admin Desk'); ?> | JOSTUM PG School</title>
