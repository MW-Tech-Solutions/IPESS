...
try {
    ...
    if (!$app) {
        $_SESSION['msg'] = ['type' => 'danger', 'text' => 'Application not found. Please check your dashboard.'];
        redirect_to('dashboard.php');
    }
...
<div class="container no-print mt-4 text-center">
    ...
    <div class="mb-4">
        ...
        <a href="../dashboard.php" class="btn btn-outline-secondary">Close</a>
    </div>
</div>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="value py-2">
                        ...
                        <span class="text-muted fw-normal">(<?php echo ($app['years_experience'] ?? 0); ?> yrs)</span>
                    </td>
                </tr>
            </tbody>
        </table>
