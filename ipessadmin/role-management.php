...
require_role(['SUPER_ADMIN', 'ICT_ADMIN'], 'login.php');
...
<main class="content-body p-4">
    <section class="page-hero mb-4">
        <div>
            <h1>Role &amp; Duty Management</h1>
            <p class="panel-muted">Define institution-wide permissions for core roles and apply custom user duty overrides.</p>
        </div>
    </section>
        ...
        <div class="col-md-12">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <h5 class="card-title mb-4">Role &amp; Duty Management Console</h5>
...
function loadRoles() {
    fetch('api/super-admin/manage-entities.php?entity=roles&action=list&t=' + new Date().getTime())
...
function openDutiesModal(roleKey, roleName) {
    ...
    fetch('api/super-admin/manage-entities.php', {
        method: 'POST',
...
document.querySelectorAll('.edit-permissions-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        fetch('api/super-admin/user-permissions.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
...
async function saveUserPermissionOverrides() {
    ...
    const res = await fetch('api/super-admin/user-permissions.php', { method: 'POST', body: form });
