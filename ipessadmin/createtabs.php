...
//$process = new ProcessorVendor();
	   ...
	   try{
		...
		$add = $con->query("INSERT INTO page_menu_tab(tab_name,open_active,tab_status) VALUES( '$tabname', 'notopen', '1' )");
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method = "POST">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Enter Tab Description</label>
