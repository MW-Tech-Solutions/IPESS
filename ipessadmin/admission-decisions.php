...
?>
    ...
    async function loadEligible() {
        ...
        const url = `api/admin/admission-decisions.php?action=eligible_students&faculty_id=${filters.faculty.value}&department_id=${filters.department.value}&programme_id=${filters.programme.value}&course_id=${filters.course.value}`;
