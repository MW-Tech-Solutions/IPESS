...
//$process = new ProcessorVendor();
	   ...
	   try{
		...
		//echo "INSERT INTO hr_salutation(Salutation,SalutationCode,titlestatus) VALUES( '$tabname','$tabname', '1' )";
		$add = $con->query("INSERT INTO hr_salutation(Salutation,SalutationCode,titlestatus) VALUES( '$tabname','$tabname', '1' )");
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add User Title</h5>
				<?php echo $msg; ?>
              <!-- Vertical Form -->
              <form class="row g-3" method = "POST">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Salutation Description</label>
                <input name="tabname" class="form-control stid" id="filedes" required>
                </div>
