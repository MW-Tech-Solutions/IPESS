...
if (!$hasAccess) {
    ...
    exit('403 Forbidden — Only Super Admins or authorized roles can access this page.');
}
...
try {
    ...
    $checkMod1->execute();
    if ((int)$checkMod1->fetchColumn() === 0) {
...
async function toggleModule(moduleKey, switchEl) {
    ...
    try {
        ...
        const response = await fetch('api/super-admin/modules.php', {
            method: 'POST',
            body: formData
        });
