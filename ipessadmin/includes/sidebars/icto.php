...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            <li>
                <a class="<?php echo $currentPage === 'dashboard.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/icto/dashboard.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'document-verification.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/icto/document-verification.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'application-management.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/general/application-management.php'); ?>">
