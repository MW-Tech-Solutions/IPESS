...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            <li>
                <a class="<?php echo $currentPage === 'dashboard.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/pg-admin/dashboard.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'document-verification.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/general/document-verification.php'); ?>">
