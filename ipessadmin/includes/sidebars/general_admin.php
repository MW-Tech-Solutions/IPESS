...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            ...
            <li>
                <a class="<?php echo $currentPage === 'applications.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/faculty/applications.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'applications.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/pg-admin/applications.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'admissions.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/ict-staff/admissions.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'supervisor-management.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/dept-admin/supervisor-management.php'); ?>">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            ...
            <li>
                <a class="<?php echo $currentPage === 'reports.php' ? 'active' : ''; ?>" href="<?php echo $canAccessSuperReports ? app_url('ADMIN/super-admin/reports.php') : app_url('ipessadmin/admin/reports.php'); ?>">
