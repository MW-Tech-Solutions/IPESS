...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-nav">
            <li>
                <a class="<?php echo $currentPage === 'dashboard.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/dept-admin/dashboard.php'); ?>">
            ...
            <li>
                <a class="<?php echo ($currentPage === 'academic-review.php' || $currentPage === 'department-applications.php') ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/dept-admin/department-applications.php'); ?>">
            ...
            <li>
                <a class="<?php echo ($currentPage === 'assign-supervisor.php' || $currentPage === 'supervisor-management.php') ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/dept-admin/supervisor-management.php'); ?>">
            ...
            <li>
                <a class="<?php echo ($currentPage === 'manage-students.php' || $currentPage === 'student-management.php') ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/dept-admin/student-management.php'); ?>">
            ...
            <li>
                <a class="<?php echo $currentPage === 'department-reports.php' ? 'active' : ''; ?>" href="<?php echo app_url('ipessadmin/dept-admin/department-reports.php'); ?>">
