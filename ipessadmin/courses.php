...
function loadFaculties() {
    fetch('api/super-admin/manage-entities.php?entity=faculties&action=list')
...
function loadProgrammes(target = programmeSelect) {
    fetch('api/super-admin/manage-entities.php?entity=degree_types&action=list')
        .then(response => response.json())
        .then(data => {
...
function deleteCourse(id) {
    ...
    fetch('api/super-admin/manage-entities.php', { method: 'POST', body: formData })
        .then(() => loadCourses());
}
