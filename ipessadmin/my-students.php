...
async function loadStudents() {
    const res = await fetch('api/supervisor/students.php?action=list');
...
async function submitFeedback() {
    ...
    const res = await fetch('api/supervisor/students.php', { method: 'POST', body: formData });
    const data = await res.json();
    if (!data.success) {
...
async function sendBulkMessage() {
    ...
    for (const student of supervisorStudents) {
        ...
        await fetch('api/supervisor/students.php', { method: 'POST', body: formData });
    }
}
</script>
