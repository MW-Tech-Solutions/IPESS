...
async function loadApplications() {
    try {
        const res = await fetch('api/general/general/academic-review.php?action=list');
...
async function submitReviewerAssignment() {
    ...
    try {
        const res = await fetch('api/general/general/academic-review.php', { method: 'POST', body: formData });
        const data = await res.json();
        if (data.success) {
